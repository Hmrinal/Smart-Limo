...
This can be done by tracking the location through GPS(global positioning systems) system. This step is taken to redefine the boundaries of emergency healthcare and help professionals provide better care than ever. The project is in initiative stage and can be enhanced by including more features.
